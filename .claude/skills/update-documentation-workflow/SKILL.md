...
description: Use when modifying code - ensures project documentation stays in sync with implementation changes
---
...
在项目中进行任何代码修改后，需要同步更新 `docs/PROJECT_SUMMARY.md`、`CLAUDE.md`、`README.md`，确保文档与实现保持一致。

**注意** 如果文件不存在，停止执行并提示错误
